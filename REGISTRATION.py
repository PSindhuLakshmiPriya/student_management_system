...
firstw=Tk()
firstw.title("Onlearning Academy")
firstw.geometry("1600x1000+0+0")
label=Label(text="Onlearning Academy",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("Onlearning Academy")
    ...
    def studentid():
        ...
        mainlabel = Label(rot, text="ENQUIRY DETAILS", font=("times new roman", 35), bg="grey")
        ...
        ttk.Style().configure("Treeview", background="white", foreground="coral1")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="Onlearning Academy", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def enquiry1():
    ...
    box2['values'] = ['SELECT', 'TO LEARN PROGRAMMING', 'TO LEARN MACHINE LEARNING', 'FEE DETAILS','TO LEARN NEW TECHNOLOGIES']
    box2.current(0)
